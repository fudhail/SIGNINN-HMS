...
export const PerformanceChart: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200/85 p-5 shadow-xs space-y-4">
      {/* Header controls */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-gray-100">
        <div>
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold uppercase tracking-wider text-gray-500">
              Performance & Yield Visualization
            </span>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {/* Metric Selector */}
          <div className="inline-flex bg-gray-100/90 p-1 rounded-xl text-xs font-medium border border-gray-200/60">
            <button
