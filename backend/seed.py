...
def _legacy_seed_database():
    ...
    # 11. OTA Channels & Integrations (Spreadsheet Partners powered by Aiosell CM)
    existing_channels_count = db.query(ChannelConfig).filter(ChannelConfig.tenant_id == "tenant-1").count()
    if existing_channels_count < 20:
        db.query(ChannelConfig).filter(ChannelConfig.tenant_id == "tenant-1").delete()
        channels = [
            # --- 18 OTAs ---
            ChannelConfig(
                id="ch-1",
            ...
            ChannelConfig(
                id="ch-2",
                tenant_id="tenant-1",
                channel_name="GoMMT (MakeMyTrip & Goibibo)",
                code="GOMMT",
                category="OTA",
                aiosell_slug="gommt",
                status="Connected",
            ...
            ChannelConfig(
                ...
                commission_rate=15.0,
                rate_multiplier=1.0,
                revenue_this_month=98000.0,
                bookings_this_month=10,
                active_listings=3,
            ),
            ChannelConfig(
                id="ch-7",
                tenant_id="tenant-1",
                channel_name="Ease My Trip",
                code="EMT",
                category="OTA",
                aiosell_slug="easemytrip",
                status="Connected",
                last_sync="20 mins ago",
                mapped_room_types=2,
                total_room_types=3,
                mapped_rate_plans=1,
                total_rate_plans=2,
            ...
            ChannelConfig(
                ...
                commission_rate=15.0,
                rate_multiplier=1.0,
                revenue_this_month=88000.0,
                bookings_this_month=7,
                active_listings=3,
            ),
            ChannelConfig(
                id="ch-9",
            ...
            ChannelConfig(
                id="ch-11",
                tenant_id="tenant-1",
                channel_name="HappyEasyGo",
                code="HEGO",
                category="OTA",
                aiosell_slug="happyeasygo",
                status="Connected",
            ...
            ChannelConfig(
                id="ch-13",
                tenant_id="tenant-1",
                channel_name="Traveloka",
                code="TVLK",
                category="OTA",
                aiosell_slug="traveloka",
                status="Connected",
                last_sync="1 hour ago",
                mapped_room_types=2,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-15",
                tenant_id="tenant-1",
                channel_name="Travolounge",
                code="TRVL",
                category="OTA",
                aiosell_slug="travolounge",
                status="Connected",
                last_sync="2 hours ago",
                mapped_room_types=2,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-17",
                tenant_id="tenant-1",
                channel_name="Bookings Maker",
                code="BKMK",
                category="OTA",
                aiosell_slug="bookingsmaker",
                status="Connected",
                last_sync="3 hours ago",
                mapped_room_types=2,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-20",
                tenant_id="tenant-1",
                channel_name="Hotelierguru",
                code="HGRU",
                category="CM",
                aiosell_slug="hotelierguru",
                status="Connected",
                last_sync="Just now",
                mapped_room_types=3,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-21",
                tenant_id="tenant-1",
                channel_name="Simplotel",
                code="SMPL",
                category="Booking Engine",
                aiosell_slug="simplotel",
                status="Connected",
                last_sync="Just now",
                mapped_room_types=3,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-22",
                tenant_id="tenant-1",
                channel_name="Travelanium",
                code="TRVLN",
                category="Booking Engine",
                aiosell_slug="travelanium",
                status="Connected",
                last_sync="1 hour ago",
                mapped_room_types=3,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-25",
                tenant_id="tenant-1",
                channel_name="RateDock",
                code="RDCK",
                category="OTA Aggregator",
                aiosell_slug="ratedock",
                status="Connected",
                last_sync="2 hours ago",
                mapped_room_types=3,
                total_room_types=3,
            ...
            ChannelConfig(
                id="ch-26",
                tenant_id="tenant-1",
                channel_name="HyperGuest",
                code="HYPR",
                category="OTA Aggregator",
                aiosell_slug="hyperguest",
                status="Connected",
                last_sync="1 hour ago",
                mapped_room_types=3,
                total_room_types=3,
