...
class Payment(Base):
    ...
    reservation_ref = Column(String(50), nullable=True, default="")
    guest_name = Column(String(255), nullable=False)
    amount = Column(Float, default=0.0)
    currency = Column(String(10), default="INR")
...
class Invoice(Base):
    ...
    issued_at = Column(String(50), default=lambda: datetime.utcnow().isoformat())
...
class HousekeepingTask(Base):
    ...
    task_type = Column(String(50), default="Turnover Clean")
...
class ChannelConfig(Base):
    ...
    category = Column(String(50), default="OTA")  # OTA, CM, Booking Engine, OTA Aggregator
    aiosell_slug = Column(String(50), nullable=True)
    inbound_email_alias = Column(String(255), nullable=True)
